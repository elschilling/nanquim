...
;(function () {
  function a(a, b, c) {
    ...
    for (var f in this.el.draw.defaults)
      (this.options[f] = this.el.draw.defaults[f]), 'undefined' != typeof c[f] && (this.options[f] = c[f])
  ...
  ;(a.prototype.transformPoint = function (a, b) {
    ...
    (a.prototype.snapToGrid = function (a) {
      ...
      if (a.length)
        return (
          (b = [a[0] % this.options.snapToGrid, a[1] % this.options.snapToGrid]),
    ...
    SVG.Element.prototype.draw.extend('rect image', {
      init: function () {
        ...
        this.el.attr({ x: a.x, y: a.y, height: 1, width: 1 })
      },
      calc: function (a) {
        ...
        ;(b.width = c.x - b.x),
          (b.height = c.y - b.y),
          this.snapToGrid(b),
          b.width < 1 && ((b.x = b.x + b.width), (b.width = -b.width)),
          b.height < 1 && ((b.y = b.y + b.height), (b.height = -b.height)),
          this.el.attr(b)
      },
    }),
    SVG.Element.prototype.draw.extend('line polyline polygon', {
      init: function () {
        ...
        this.el.plot(b), this.drawCircles(this.el.array().valueOf())
      },
      calc: function (a) {
      ...
      point: function (a) {
        if (this.el.type.indexOf('poly') > -1) {
          ...
          return (
            ...
            void this.el.fire('drawpoint', { event: a, p: { x: b.x, y: b.y }, m: this.m })
          )
        }
        this.stop(a)
      },
    ...
    SVG.Element.prototype.draw.extend('circle', {
      init: function () {
        var a = this.startPoint
        this.el.attr({ cx: a.x, cy: a.y, r: 1 })
      },
      calc: function (a) {
        var b = this.transformPoint(a.clientX, a.clientY),
          c = {
    ...
    SVG.Element.prototype.draw.extend('ellipse', {
      init: function () {
        var a = this.startPoint
        this.el.attr({ cx: a.x, cy: a.y, rx: 1, ry: 1 })
      },
      calc: function (a) {
        var b = this.transformPoint(a.clientX, a.clientY),
          c = { cx: this.startPoint.x, cy: this.startPoint.y, rx: Math.abs(b.x - this.startPoint.x), ry: Math.abs(b.y - this.startPoint.y) }
        this.snapToGrid(c), this.el.attr(c)
      },
    })
}).call(this)
