/*! svg.js v2.0.0 MIT*/ !(function (t, e) {
  ...
  function i(t) {
    return 4 == t.length
      ? ['#', t.substring(1, 2), t.substring(1, 2), t.substring(2, 3), t.substring(2, 3), t.substring(3, 4), t.substring(3, 4)].join('')
      : t
  }
  function n(t) {
    var e = t.toString(16)
  ...
  function u(t) {
    return (
      (t = t.replace(m.regex.whitespace, '').replace(m.regex.matrix, '').split(',')),
      o(
        m.utils.map(t, function (t) {
          return parseFloat(t)
        })
      )
    )
  ...
  function l(t, e) {
    return 'number' == typeof t.from
      ? t.from + (t.to - t.from) * e
      : t instanceof m.Color || t instanceof m.Number || t instanceof m.Matrix
      ? t.at(e)
      : 1 > e
      ? t.from
      : t.to
        ...
        null != t[e][1] &&
          ...
          null != t[e][2] &&
            ...
            null != t[e][3] &&
              ...
              (n += t[e][4]),
              null != t[e][5] &&
                ((n += ' '), (n += t[e][5]), (n += ' '), (n += t[e][6]), null != t[e][7] && ((n += ' '), (n += t[e][7]))))))
    return n + ' '
  }
  function f(t) {
  ...
  ;(m.did = 1e3),
        ...
        (i =
          'svg' == t.nodeName
            ? t.parentNode instanceof SVGElement
              ? new m.Nested()
              : new m.Doc()
            : 'lineairGradient' == t.nodeName
            ? new m.Gradient('lineair')
            : 'radialGradient' == t.nodeName
            ? new m.Gradient('radial')
            : m[e(t.nodeName)]
            ? new m[e(t.nodeName)]()
            : new m.Element(t)),
        (i.type = t.nodeName),
    ...
    (m.Color = function (t) {
      ...
      ;(this.r = 0),
        ...
        (this.b = 0),
        'string' == typeof t
          ? m.regex.isRgb.test(t)
            ? ((e = m.regex.rgb.exec(t.replace(/\s/g, ''))),
              (this.r = parseInt(e[1])),
              (this.g = parseInt(e[2])),
              (this.b = parseInt(e[3])))
            : m.regex.isHex.test(t) &&
              ((e = m.regex.hex.exec(i(t))), (this.r = parseInt(e[1], 16)), (this.g = parseInt(e[2], 16)), (this.b = parseInt(e[3], 16)))
    ...
    m.extend(m.PathArray, {
      ...
      parse: function (t) {
        ...
        var e,
          ...
          p = 0
        for (
          m.parser.path.setAttribute('d', 'string' == typeof t ? t : c(t)), f = m.parser.path.pathSegList, e = 0, i = f.numberOfItems;
          i > e;
          ++e
        )
          (l = f.getItem(e)),
            (u = l.pathSegTypeAsLetter),
            'M' == u || 'L' == u || 'H' == u || 'V' == u || 'C' == u || 'S' == u || 'Q' == u || 'T' == u || 'A' == u
              ? ('x' in l && (d = l.x), 'y' in l && (p = l.y))
              : ('x1' in l && (s = d + l.x1),
                'x2' in l && (a = d + l.x2),
                'y1' in l && (o = p + l.y1),
                'y2' in l && (h = p + l.y2),
                ...
                'y' in l && (p += l.y),
                'm' == u
                  ? f.replaceItem(m.parser.path.createSVGPathSegMovetoAbs(d, p), e)
                  : 'l' == u
                  ? f.replaceItem(m.parser.path.createSVGPathSegLinetoAbs(d, p), e)
                  : 'h' == u
                  ? f.replaceItem(m.parser.path.createSVGPathSegLinetoHorizontalAbs(d), e)
                  : 'v' == u
                  ? f.replaceItem(m.parser.path.createSVGPathSegLinetoVerticalAbs(p), e)
                  : 'c' == u
                  ? f.replaceItem(m.parser.path.createSVGPathSegCurvetoCubicAbs(d, p, s, o, a, h), e)
                  : 's' == u
                  ? f.replaceItem(m.parser.path.createSVGPathSegCurvetoCubicSmoothAbs(d, p, a, h), e)
                  : 'q' == u
                  ? f.replaceItem(m.parser.path.createSVGPathSegCurvetoQuadraticAbs(d, p, s, o), e)
                  : 't' == u
                  ? f.replaceItem(m.parser.path.createSVGPathSegCurvetoQuadraticSmoothAbs(d, p), e)
                  : 'a' == u
                  ? f.replaceItem(m.parser.path.createSVGPathSegArcAbs(d, p, l.r1, l.r2, l.angle, l.largeArcFlag, l.sweepFlag), e)
                  : ('z' == u || 'Z' == u) && ((d = n), (p = r))),
            ('M' == u || 'm' == u) && ((n = d), (r = p))
        for (t = [], f = m.parser.path.pathSegList, e = 0, i = f.numberOfItems; i > e; ++e)
          (l = f.getItem(e)),
            (u = l.pathSegTypeAsLetter),
            (d = [u]),
            'M' == u || 'L' == u || 'T' == u
              ...
              ? d.push(l.y)
              : 'C' == u
              ? d.push(l.x1, l.y1, l.x2, l.y2, l.x, l.y)
              : 'S' == u
              ? d.push(l.x2, l.y2, l.x, l.y)
              : 'Q' == u
              ? d.push(l.x1, l.y1, l.x, l.y)
              : 'A' == u && d.push(l.r1, l.r2, l.angle, 0 | l.largeArcFlag, 0 | l.sweepFlag, l.x, l.y),
            t.push(d)
        return t
      },
      bbox: function () {
      ...
      create: function (t, e) {
        ;(this.value = 0),
          ...
          'number' == typeof t
            ...
            : 'string' == typeof t
            ? ((e = t.match(m.regex.unit)),
              e &&
                ((this.value = parseFloat(e[1])),
                '%' == e[2] ? (this.value /= 100) : 's' == e[2] && (this.value *= 1e3),
                (this.unit = e[2])))
            : t instanceof m.Number && ((this.value = t.valueOf()), (this.unit = t.unit))
      },
      extend: {
        toString: function () {
    ...
    (m.ViewBox = function (t) {
      var e,
        ...
        u = t,
        l = t
      for (n = new m.Number(t.width()), r = new m.Number(t.height()); '%' == n.unit; )
        (s *= n.value), (n = new m.Number(u instanceof m.Doc ? u.parent().offsetWidth : u.parent().width())), (u = u.parent())
      for (; '%' == r.unit; )
        (o *= r.value), (r = new m.Number(l instanceof m.Doc ? l.parent().offsetHeight : l.parent().height())), (l = l.parent())
      ;(this.x = a.x),
        (this.y = a.y),
        (this.width = n * s),
        (this.height = r * o),
      ...
      extend: {
        ...
        svg: function (t) {
          ...
          if (!(t && this instanceof m.Parent))
            return (
              e.appendChild((t = document.createElement('svg'))),
      ...
      extend: {
        animate: function (t, e, i) {
          var n,
            ...
            a = this
          return (
            'object' == typeof t && ((i = t.delay), (e = t.ease), (t = t.duration)),
            ...
            (a.at = function (t) {
              ...
              if (((t = 0 > t ? 0 : t > 1 ? 1 : t), null == n)) {
                ...
                if (o.morphArray && (a.destination.plot || n.indexOf('points') > -1)) {
                  ...
                  a.destination.size && u.size(a.destination.size.width.to, a.destination.size.height.to),
                    ...
                    (a.destination = { plot: o.array.morph(u) })
                }
              }
              if (null == r) {
                r = []
              ...
              for (
                t =
                  '<>' == e
                    ...
                    : t,
                  a.destination.plot
                    ? o.plot(a.destination.plot.at(t))
                    : (a.destination.x ? o.x(a.destination.x.at(t)) : a.destination.cx && o.cx(a.destination.cx.at(t)),
                  ...
                  a.destination.viewbox &&
                    o.viewbox(
                      a.destination.viewbox.x.at(t),
                      a.destination.viewbox.y.at(t),
                      a.destination.viewbox.width.at(t),
                      a.destination.viewbox.height.at(t)
                    ),
              ...
              a.situation.during &&
                a.situation.during.call(o, t, function (e, i) {
                  ...
                  (a.render = function () {
                    if (a.situation.play === !0) {
                      ...
                      a.situation.reversing && (r = -r + 1),
                        a.at(r),
                        n > a.situation.finish
                          ? (a.destination.plot && o.plot(new m.PointArray(a.destination.plot.destination).settle()),
                            a.situation.loop === !0 || ('number' == typeof a.situation.loop && a.situation.loop > 0)
                              ? (a.situation.reverse && (a.situation.reversing = !a.situation.reversing),
                                'number' == typeof a.situation.loop &&
                                  ((!a.situation.reverse || a.situation.reversing) && --a.situation.loop,
                                  a.situation.reverse || 1 != a.situation.loop || --a.situation.loop),
                                a.animate(t, e, i))
                              : a.situation.after
                              ? a.situation.after.apply(o, [a])
                              : a.stop())
        ...
        attr: function (t, e) {
          if ('object' == typeof t) for (var i in t) this.attr(i, t[i])
            ...
            'transform' == t
              ? (this.attrs[t] && (e = this.attrs[t].destination.multiply(e)),
                (this.attrs[t] = this.target.ctm().morph(e)),
                this.param &&
                  ((e = this.target.transform('rotation')),
                  (this.attrs[t].param = {
                    from: this.target.param || { rotation: e, cx: this.param.cx, cy: this.param.cy },
                    to: this.param,
                  })))
              : (this.attrs[t] = m.Color.isColor(e)
                  ? new m.Color(n).morph(e)
                  : m.regex.unit.test(e)
                  ? new m.Number(n).morph(e)
                  : { from: n, to: e })
          }
          return this
        },
        style: function (t, e) {
          ...
          else this.styles[t] = { from: this.target.style(t), to: e }
          return this
        },
        x: function (t) {
        ...
        size: function (t, e) {
          if (this.target instanceof m.Text) this.attr('font-size', t)
          else {
            var i = this.target.bbox()
            this.destination.size = { width: new m.Number(i.width).morph(t), height: new m.Number(i.height).morph(e) }
          }
          return this
        },
        plot: function (t) {
        ...
        leading: function (t) {
          return (
            this.target.destination.leading && (this.destination.leading = new m.Number(this.target.destination.leading).morph(t)), this
          )
        },
        ...
        stop: function (t) {
          return (
            t === !0
              ? (this.animate(0), this.situation.after && this.situation.after.apply(this.target, [this]))
      ...
      create: function (t) {
        if (t) {
          var e = t.doc().parent(),
            ...
            n = 1
          for (this.x = i.left, this.y = i.top, this.x -= e.offsetLeft, this.y -= e.offsetTop; (e = e.offsetParent); )
    ...
    (m.Matrix = m.invent({
      ...
      extend: {
        ...
        around: function (t, e, i) {
          return this.multiply(new m.Matrix(1, 0, 0, 1, t || 0, e || 0))
            .multiply(i)
            .multiply(new m.Matrix(1, 0, 0, 1, -t || 0, -e || 0))
        },
        native: function () {
    ...
    m.extend(m.Element, {
      attr: function (t, e, i) {
        ...
        if ('object' == typeof t) for (e in t) this.attr(e, t[e])
          ...
          if (null == e)
            return (e = this.node.getAttribute(t)), null == e ? m.defaults.attrs[t] : m.regex.isNumber.test(e) ? parseFloat(e) : e
          'stroke-width' == t ? this.attr('stroke', parseFloat(e) > 0 ? this._stroke : null) : 'stroke' == t && (this._stroke = e),
            ('fill' == t || 'stroke' == t) &&
              (m.regex.isImage.test(e) && (e = this.doc().defs().image(e, 0, 0)),
              e instanceof m.Image &&
                (e = this.doc()
                  .defs()
            ...
            'number' == typeof e
              ...
              : Array.isArray(e)
              ? (e = new m.Array(e))
              : e instanceof m.Matrix && e.param && (this.param = e.param),
            'leading' == t
    ...
    m.extend(m.Element, m.FX, {
      transform: function (t, e) {
        ...
        if ('object' != typeof t)
          return (
            (i = n.ctm().extract()),
            'object' == typeof this.param && ((i.rotation = this.param.rotation), (i.cx = this.param.cx), (i.cy = this.param.cy)),
            'string' == typeof t ? i[t] : i
          )
        if (
          ((i = this instanceof m.FX && this.attrs.transform ? this.attrs.transform : new m.Matrix(n)),
          (e = !!e || !!t.relative),
          null != t.a)
        )
          ...
          h(t, n),
            ...
            (this.param = t),
            this instanceof m.Element &&
              (i = e
                ? n.attr('transform', i + ' rotate(' + [t.rotation, t.cx, t.cy].join() + ')').ctm()
          ...
          t.flip
            ? (i = i.flip(t.flip, null == t.offset ? n.bbox()['c' + t.flip] : t.offset))
            : (null != t.x || null != t.y) && (e ? (i = i.translate(t.x, t.y)) : (null != t.x && (i.e = t.x), null != t.y && (i.f = t.y)))
    ...
    m.extend(m.Element, {
      style: function (e, i) {
        ...
        if (arguments.length < 2)
          if ('object' == typeof e) for (i in e) this.style(i, e[i])
          else {
    ...
    (m.Parent = m.invent({
      ...
      extend: {
        ...
        add: function (t, e) {
          return (
            this.has(t) || ((e = null == e ? this.children().length : e), this.node.insertBefore(t.node, this.node.childNodes[e] || null)),
            this
          )
        },
        put: function (t, e) {
        ...
        each: function (t, e) {
          ...
          for (i = 0, n = r.length; n > i; i++)
            r[i] instanceof m.Element && t.apply(r[i], [i, r]), e && r[i] instanceof m.Container && r[i].each(t, e)
          return this
        },
      ...
      extend: {
        viewbox: function (t) {
          return 0 == arguments.length
            ? new m.ViewBox(this)
            : ((t = 1 == arguments.length ? [t.x, t.y, t.width, t.height] : [].slice.call(arguments)), this.attr('viewBox', t))
        },
      },
    })),
    [
    ...
    (m.off = function (t, e, i) {
      ...
      if (-1 != n)
        if (i)
          m.listeners[n][r] &&
            m.listeners[n][r][s || '*'] &&
            (t.removeEventListener(r, m.listeners[n][r][s || '*'][i], !1), delete m.listeners[n][r][s || '*'][i])
        else if (s) {
    ...
    (m.Defs = m.invent({ create: 'defs', inherit: m.Container })),
    (m.G = m.invent({
      create: 'g',
      inherit: m.Container,
      extend: {
    ...
    m.extend(m.Element, {
      maskWith: function (t) {
        return (
          (this.masker = t instanceof m.Mask ? t : this.parent().mask().add(t)),
    ...
    m.extend(m.Element, {
      clipWith: function (t) {
        return (
          (this.clipper = t instanceof m.ClipPath ? t : this.parent().clip().add(t)),
    ...
    m.extend(m.Gradient, m.FX, {
      from: function (t, e) {
        return 'radial' == (this.target || this).type
          ? this.attr({ fx: new m.Number(t), fy: new m.Number(e) })
          : this.attr({ x1: new m.Number(t), y1: new m.Number(e) })
      },
      to: function (t, e) {
        return 'radial' == (this.target || this).type
          ? this.attr({ cx: new m.Number(t), cy: new m.Number(e) })
    ...
    (m.Stop = m.invent({
      ...
      extend: {
        update: function (t) {
          return (
            ('number' == typeof t || t instanceof m.Number) && (t = { offset: arguments[0], color: arguments[1], opacity: arguments[2] }),
            null != t.opacity && this.attr('stop-opacity', t.opacity),
            null != t.color && this.attr('stop-color', t.color),
            null != t.offset && this.attr('offset', new m.Number(t.offset)),
            this
    ...
    (m.Doc = m.invent({
      create: function (t) {
        t &&
          ...
          'svg' == t.nodeName ? this.constructor.call(this, t) : (this.constructor.call(this, m.create('svg')), t.appendChild(this.node)),
    ...
    (m.Bare = m.invent({
      create: function (t, e) {
        if ((this.constructor.call(this, m.create(t)), e))
          for (var i in e.prototype) 'function' == typeof e.prototype[i] && (t[i] = e.prototype[i])
      },
      inherit: m.Element,
      extend: {
        words: function (t) {
          ...
          return (
            (i.onload = function () {
              ...
              0 == e.width() && 0 == e.height() && e.size(i.width, i.height),
                ...
                'function' == typeof e._loaded && e._loaded.call(e, { width: i.width, height: i.height, ratio: i.width / i.height, url: t })
            }),
      ...
      extend: {
        ...
        rebuild: function (t) {
          if (('boolean' == typeof t && (this._rebuild = t), this._rebuild)) {
            ...
            this.lines().each(function () {
              this.newLined &&
                (this.textPath || this.attr('x', e.attr('x')), this.attr('dy', e._leading * new m.Number(e.attr('font-size'))))
            }),
              this.fire('rebuild')
          }
          return this
  ...
  ;['fill', 'stroke'].forEach(function (t) {
    var e,
      i = {}
    ;(i[t] = function (i) {
      if ('string' == typeof i || m.Color.isRgb(i) || (i && 'function' == typeof i.fill)) this.attr(t, i)
      else for (e = x[t].length - 1; e >= 0; e--) null != i[x[t][e]] && this.attr(x.prefix(t, x[t][e]), i[x[t][e]])
      return this
    }),
    ...
    (m.select = function (t, e) {
      return new m.Set(
        m.utils.map((e || document).querySelectorAll(t), function (t) {
          return m.adopt(t)
        })
      )
    }),
