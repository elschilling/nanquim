 ...
 * @license MIT
 *
 * BUILT: Sat Dec 30 2023 14:52:31 GMT-0300 (Brasilia Standard Time)
 */ ;(function (svg_js) {
  'use strict'
    ...
    function PaintHandler(el, event, options) {
      ...
      if (!event) {
        if (options.startPoint) {
          _this.start(options.startPoint)
        }
      ...
      [
        ...
        },
        {
          ...
          value: function stop(e) {
            ...
            if (e) {
              var p = this.transformPoint(e.clientX, e.clientY)
              this.el.fire('drawstop', this.arr)
            }
          },
        ...
        },
        {
          ...
          value: function done() {
            this.calc()
            this.stop()
            this.el.fire('drawdone', this.arr)
          },
