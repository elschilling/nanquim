...
| `native-v2.svg` | Minimal current Nanquim schema-v2 document with collections, styles, definitions, a block instance, Paper metadata, and empty Geometry Nodes metadata. | Authored for the Nanquim test suite on 2026-08-20. | GPL-3.0-only |
